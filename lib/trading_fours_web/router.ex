defmodule TradingFoursWeb.Router do
  ...
  # scope "/api", TradingFoursWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:trading_fours, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: TradingFoursWeb.Telemetry
